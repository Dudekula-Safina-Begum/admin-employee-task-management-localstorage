...
const Failedtask = ({data}) => {
  return (
    <div className='flex-shrink-0 h-full bg-red-400 w-[22vw] px-[2vw] rounded-xl '>
            ...
            <div className='flex justify-center mt-4  '>
                ...
                <button className='bg-green-400 py-1 px-2 text-sm rounded-md border-2 border-green-500'> Failed</button>
